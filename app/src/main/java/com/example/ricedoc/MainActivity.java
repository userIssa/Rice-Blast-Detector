...
import com.example.ricedoc.ml.Ricemodel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        picture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //launches camera is permission allowed
    ...
    private void classifyImage(Bitmap image) {
        try {
            Ricemodel model = Ricemodel.newInstance(getApplicationContext());
            ...
            //get 1D arrray of 224 * 224 pixels in image
            ...
            //run model interface and gets results
            ...
            String[] classes = {"Healthy Leaf", "Leaf Blast"};
